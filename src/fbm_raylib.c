...
void fbm_init(FBMState *state, u32 dim_x, u32 dim_y, u8 *heightmap_data) {
  ...
  g_fbm_slider_x_offset = 10.0f + (f32)MeasureText("lacunarity: ", fonst_size);
}
